...
export class ElementsPage {
  ...
  async navigateToDynamicPropertiesPage(): Promise<DynamicPropertiesPage> {
    await this.dynamicProperties.waitFor({ state: 'visible' });
    await this.dynamicProperties.hover();
    await this.dynamicProperties.click();
    const dynamicPropertiesPageObj = new DynamicPropertiesPage(this.page);
    return dynamicPropertiesPageObj;
  }
